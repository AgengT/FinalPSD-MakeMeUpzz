<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateMakeupTypePage.aspx.cs" Inherits="MakeMeUpzz.View.UpdateMakeupTypePage" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Button ID="UpdateMakeupType" runat="server" Text="UpdateMakeupType" OnClick="UpdateMakeupType_Click" />
