<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateMakeupBrandPage.aspx.cs" Inherits="MakeMeUpzz.View.UpdateMakeupBrandPage" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Button ID="UpdateMakeupBrand" runat="server" Text="UpdateMakeupBrand" OnClick="UpdateMakeupBrand_Click" />
